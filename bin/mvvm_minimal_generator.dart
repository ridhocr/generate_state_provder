...
void main(List<String> arguments) async {
  ...
  final files = {
    ...
    'lib/service/lokal/shared_prefference.dart': """import 'package:shared_preferences/shared_preferences.dart';
...
class SharedPreferenceService {
  ...
  Future removeSharedPref() async {
    ...
    'lib/viewmodel/example_viewmodel.dart': """import 'package:flutter/material.dart';
